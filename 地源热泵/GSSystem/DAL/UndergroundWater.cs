	...
	public partial class UndergroundWater
	{
		...
		public int Add(GSSystem.Model.UndergroundWater model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@WellNum", SqlDbType.VarChar,50),
					new SqlParameter("@WEWNum", SqlDbType.VarChar,50),
					new SqlParameter("@RWNum", SqlDbType.VarChar,50),
					new SqlParameter("@WellDepth", SqlDbType.VarChar,50),
					new SqlParameter("@SWWExtract", SqlDbType.VarChar,50),
					new SqlParameter("@HeatTime", SqlDbType.VarChar,50),
					new SqlParameter("@CoolTime", SqlDbType.VarChar,50),
					new SqlParameter("@WPDiameter", SqlDbType.VarChar,50),
					new SqlParameter("@WPipe", SqlDbType.VarChar,50),
					new SqlParameter("@BWPDiameter", SqlDbType.VarChar,50),
					new SqlParameter("@BWPipe", SqlDbType.VarChar,50),
					new SqlParameter("@DModel", SqlDbType.VarChar,50),
					new SqlParameter("@WTIModel", SqlDbType.VarChar,50),
					new SqlParameter("@CPETModel", SqlDbType.VarChar,50),
					new SqlParameter("@CPETNum", SqlDbType.VarChar,50),
					new SqlParameter("@FWTSize", SqlDbType.VarChar,50),
					new SqlParameter("@WSPNum", SqlDbType.VarChar,50),
					new SqlParameter("@WPPower", SqlDbType.VarChar,50),
					new SqlParameter("@PVFreque", SqlDbType.VarChar,50)};
