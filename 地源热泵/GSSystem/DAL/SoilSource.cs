	...
	public partial class SoilSource
	{
		...
		public int Add(GSSystem.Model.SoilSource model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@PHoleNum", SqlDbType.VarChar,50),
					new SqlParameter("@HoleDepth", SqlDbType.VarChar,50),
					new SqlParameter("@HoleDistance", SqlDbType.VarChar,50),
					new SqlParameter("@UHEMaterial", SqlDbType.VarChar,50),
					new SqlParameter("@UHEDiameter", SqlDbType.VarChar,50),
					new SqlParameter("@HeatTime", SqlDbType.VarChar,50),
					new SqlParameter("@CoolTime", SqlDbType.VarChar,50),
					new SqlParameter("@BPFormat", SqlDbType.VarChar,50),
					new SqlParameter("@UHEUType", SqlDbType.VarChar,50),
					new SqlParameter("@UHESparallel", SqlDbType.VarChar,50),
					new SqlParameter("@UHETotalLen", SqlDbType.VarChar,50),
