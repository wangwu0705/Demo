	...
	public partial class ProjectCost
	{
		...
		public int Add(GSSystem.Model.ProjectCost model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@ProTotalCost", SqlDbType.VarChar,50),
					new SqlParameter("@UnitCost", SqlDbType.VarChar,50),
					new SqlParameter("@SystemCost", SqlDbType.VarChar,50),
					new SqlParameter("@ProTel", SqlDbType.VarChar,50)};
