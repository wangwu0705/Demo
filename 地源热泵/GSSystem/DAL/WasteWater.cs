	...
	public partial class WasteWater
	{
		...
		public int Add(GSSystem.Model.WasteWater model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@SPNum", SqlDbType.VarChar,50),
					new SqlParameter("@SPHead", SqlDbType.VarChar,50),
					new SqlParameter("@SPFlow", SqlDbType.VarChar,50),
					new SqlParameter("@SPPower", SqlDbType.VarChar,50),
					new SqlParameter("@HEType", SqlDbType.VarChar,50),
					new SqlParameter("@HENum", SqlDbType.VarChar,50),
					new SqlParameter("@HEHEArea", SqlDbType.VarChar,50),
					new SqlParameter("@SInTemp", SqlDbType.VarChar,50),
					new SqlParameter("@SOutTemp", SqlDbType.VarChar,50),
					new SqlParameter("@SFlow", SqlDbType.VarChar,50),
					new SqlParameter("@WTIModel", SqlDbType.VarChar,50),
					new SqlParameter("@CPETMode", SqlDbType.VarChar,50),
