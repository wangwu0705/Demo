...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2016/9/27 11:22:38   N/A    初版
*
...
namespace GSSystem.DAL
{
	...
	public partial class ProjectCommonCity
	{
		...
		public int Add(GSSystem.Model.ProjectCommonCity model)
		{
			...
			strSql.Append("ProName,ProAdd,ProType,ConUnit,HpManufacturer,FinTime,CoveredArea,HpType,EngCharacter,UseFormat,TerminalForm,ProjectTHHp,ProjectTCHp,HpEquipmentType,HpEquipmentNum,NominalHeat,NominalCool,HeatInputPower,CoolInputPower,WType,DetailAdd)");
			strSql.Append(" values (");
			strSql.Append("@ProName,@ProAdd,@ProType,@ConUnit,@HpManufacturer,@FinTime,@CoveredArea,@HpType,@EngCharacter,@UseFormat,@TerminalForm,@ProjectTHHp,@ProjectTCHp,@HpEquipmentType,@HpEquipmentNum,@NominalHeat,@NominalCool,@HeatInputPower,@CoolInputPower,@WType,@DetailAdd)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@ProName", SqlDbType.VarChar,50),
					new SqlParameter("@ProAdd", SqlDbType.VarChar,50),
					new SqlParameter("@ProType", SqlDbType.VarChar,50),
					new SqlParameter("@ConUnit", SqlDbType.VarChar,50),
					new SqlParameter("@HpManufacturer", SqlDbType.VarChar,50),
					new SqlParameter("@FinTime", SqlDbType.DateTime),
					new SqlParameter("@CoveredArea", SqlDbType.VarChar,50),
					new SqlParameter("@HpType", SqlDbType.VarChar,50),
					new SqlParameter("@EngCharacter", SqlDbType.VarChar,50),
					new SqlParameter("@UseFormat", SqlDbType.VarChar,50),
					new SqlParameter("@TerminalForm", SqlDbType.VarChar,50),
					new SqlParameter("@ProjectTHHp", SqlDbType.Int,4),
					new SqlParameter("@ProjectTCHp", SqlDbType.Int,4),
					new SqlParameter("@HpEquipmentType", SqlDbType.VarChar,50),
					new SqlParameter("@HpEquipmentNum", SqlDbType.Int,4),
					new SqlParameter("@NominalHeat", SqlDbType.VarChar,50),
					new SqlParameter("@NominalCool", SqlDbType.VarChar,50),
					new SqlParameter("@HeatInputPower", SqlDbType.VarChar,50),
					new SqlParameter("@CoolInputPower", SqlDbType.VarChar,50),
					new SqlParameter("@WType", SqlDbType.VarChar,50),
					new SqlParameter("@DetailAdd", SqlDbType.VarChar,50)};
			...
			parameters[20].Value = model.DetailAdd;
		...
		public bool Update(GSSystem.Model.ProjectCommonCity model)
		{
			...
			strSql.Append("DetailAdd=@DetailAdd");
		...
		public GSSystem.Model.ProjectCommonCity GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,ProName,ProAdd,ProType,ConUnit,HpManufacturer,FinTime,CoveredArea,HpType,EngCharacter,UseFormat,TerminalForm,ProjectTHHp,ProjectTCHp,HpEquipmentType,HpEquipmentNum,NominalHeat,NominalCool,HeatInputPower,CoolInputPower,WType,DetailAdd from ProjectCommonCity ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public GSSystem.Model.ProjectCommonCity DataRowToModel(DataRow row)
		{
			...
			if (row != null)
			{
				...
				if(row["DetailAdd"]!=null)
				{
					model.DetailAdd=row["DetailAdd"].ToString();
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,ProName,ProAdd,ProType,ConUnit,HpManufacturer,FinTime,CoveredArea,HpType,EngCharacter,UseFormat,TerminalForm,ProjectTHHp,ProjectTCHp,HpEquipmentType,HpEquipmentNum,NominalHeat,NominalCool,HeatInputPower,CoolInputPower,WType,DetailAdd ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,ProName,ProAdd,ProType,ConUnit,HpManufacturer,FinTime,CoveredArea,HpType,EngCharacter,UseFormat,TerminalForm,ProjectTHHp,ProjectTCHp,HpEquipmentType,HpEquipmentNum,NominalHeat,NominalCool,HeatInputPower,CoolInputPower,WType,DetailAdd ");
			strSql.Append(" FROM ProjectCommonCity ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public int GetRecordCount(string strWhere)
		{
			...
			if(strWhere.Trim()!="")
			{
                strSql.Append(" where ProAdd='" + strWhere + "'");
			}
