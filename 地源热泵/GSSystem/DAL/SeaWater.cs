	...
	public partial class SeaWater
	{
		...
		public int Add(GSSystem.Model.SeaWater model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@SWWellNum", SqlDbType.VarChar,50),
					new SqlParameter("@SWWellDep", SqlDbType.VarChar,50),
					new SqlParameter("@CWPNum", SqlDbType.VarChar,50),
					new SqlParameter("@CWPHead", SqlDbType.VarChar,50),
					new SqlParameter("@CWPFlow", SqlDbType.VarChar,50),
					new SqlParameter("@CWPPower", SqlDbType.VarChar,50),
					new SqlParameter("@ExHeatType", SqlDbType.VarChar,50),
					new SqlParameter("@ExHeatNum", SqlDbType.VarChar,50),
					new SqlParameter("@ExHeatArea", SqlDbType.VarChar,50),
					new SqlParameter("@SWInTemp", SqlDbType.VarChar,50),
					new SqlParameter("@SWOutTemp", SqlDbType.VarChar,50),
					new SqlParameter("@SeaWaterFlow", SqlDbType.VarChar,50),
					new SqlParameter("@DesanderNum", SqlDbType.VarChar,50),
					new SqlParameter("@DesanderType", SqlDbType.VarChar,50),
					new SqlParameter("@SoftWTSize", SqlDbType.VarChar,50),
					new SqlParameter("@SoftWType", SqlDbType.VarChar,50),
					new SqlParameter("@WPNum", SqlDbType.VarChar,50),
					new SqlParameter("@WPpower", SqlDbType.VarChar,5),
					new SqlParameter("@PVariableFre", SqlDbType.VarChar,50)};
