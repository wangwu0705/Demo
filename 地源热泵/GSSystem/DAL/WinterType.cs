	...
	public partial class WinterType
	{
		...
		public int Add(GSSystem.Model.WinterType model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@WWPWTemp", SqlDbType.VarChar,50),
					new SqlParameter("@WWRWTemp", SqlDbType.VarChar,50),
					new SqlParameter("@WHSSInWTemp", SqlDbType.VarChar,50),
					new SqlParameter("@WHSSBackWTemp", SqlDbType.VarChar,50),
					new SqlParameter("@WHSSCWater", SqlDbType.VarChar,50),
					new SqlParameter("@WUEWSTemp", SqlDbType.VarChar,50),
					new SqlParameter("@WUEBWTemp", SqlDbType.VarChar,50),
					new SqlParameter("@WUECircul", SqlDbType.VarChar,50),
					new SqlParameter("@WRTempeRange", SqlDbType.VarChar,50)};
