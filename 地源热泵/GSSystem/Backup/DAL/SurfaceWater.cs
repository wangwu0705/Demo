	...
	public partial class SurfaceWater
	{
		...
		public int Add(GSSystem.Model.SurfaceWater model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@WPHead", SqlDbType.VarChar,5),
					new SqlParameter("@WPFlow", SqlDbType.VarChar,5),
					new SqlParameter("@WPPower", SqlDbType.VarChar,5),
					new SqlParameter("@HEType", SqlDbType.VarChar,5),
					new SqlParameter("@HENum", SqlDbType.VarChar,5),
					new SqlParameter("@HEHeatArea", SqlDbType.VarChar,5),
					new SqlParameter("@SWITemp", SqlDbType.VarChar,5),
					new SqlParameter("@SWOTemp", SqlDbType.VarChar,5),
					new SqlParameter("@SWFlow", SqlDbType.VarChar,5),
					new SqlParameter("@DNum", SqlDbType.VarChar,5),
					new SqlParameter("@DType", SqlDbType.VarChar,5),
					new SqlParameter("@SWTSize", SqlDbType.VarChar,5),
					new SqlParameter("@SWTType", SqlDbType.VarChar,5),
