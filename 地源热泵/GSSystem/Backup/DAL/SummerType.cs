	...
	public partial class SummerType
	{
		...
		public int Add(GSSystem.Model.SummerType model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@SHSSInWTemp", SqlDbType.VarChar,6),
					new SqlParameter("@SHSSBackWTemp", SqlDbType.VarChar,6),
					new SqlParameter("@SHSSCWater", SqlDbType.VarChar,6),
					new SqlParameter("@SUEWSTemp", SqlDbType.VarChar,6),
					new SqlParameter("@SUEBWTemp", SqlDbType.VarChar,6),
					new SqlParameter("@SUECircul", SqlDbType.VarChar,6),
					new SqlParameter("@SRTempRange", SqlDbType.VarChar,6)};
