...
namespace GSSystem.Web.USCP
{
	...
	private void ShowInfo(int id)
	{
		...
		this.lblUSCPNum.Text=model.USCPNum.ToString();
		this.lblUSCPPower.Text=model.USCPPower;
		this.lblUSCPHead.Text=model.USCPHead;
		this.lblUSCPFlow.Text=model.USCPFlow;
