<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchAds.aspx.cs" Inherits="GSSystem.Web.Search.SearchAds" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <div>
                <img src="../Admin/left.files/dzcx.jpg" width="100%" style="height: 146px; margin-bottom: 0px;" />
            </div>
            <table style="font-size: 9pt; " cellpadding="0" cellspacing="0" align="center" border="0" width="100%" bgcolor="lavender">
                <tr>
                    <td colspan="3" style="text-align: left"  Width="50%">
                        <asp:Label ID="Label2" runat="server" Text="根据项目地址查询" Font-Size="Large"></asp:Label>
                        &nbsp;
