<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchType.aspx.cs" Inherits="GSSystem.Web.Search.SearchType" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <div>
                <img src="../Admin/left.files/rblxcx.jpg" width="100%" style="height: 146px" /></div>
            <table style="font-size: 9pt; " cellpadding="0" cellspacing="0" align="center" border="0" width="100%" bgcolor="lavender">
                <tr height="30px">
                    <td style="text-align: right">
                        <asp:Label ID="Label2" runat="server" Text="根据热泵类型查询" Font-Size="Large"></asp:Label>
                        &nbsp;                    
                    </td>
                    <td>
                        <asp:TextBox ID="txtKey" runat="server"></asp:TextBox></td>
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="地区" Font-Size="Large"></asp:Label></td>
                    <td>
                        <asp:TextBox ID="txtKey1" runat="server"></asp:TextBox></td>
                    <td>
                        <asp:Button ID="btnSel" runat="server" Text="查询" Height="26px" Width="59px" OnClick="btnSel_Click" Font-Size="Large"/>
                        &nbsp;</td>
                </tr>
            </table>
            <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bordercolor="#799AE1" class="tableBorder">
                        <tbody>
                            ...
                            <tr align="center" bgcolor="#799AE1">
                                ...
                                <td width="15%" align="center" class="txlHeaderBackgroundAlternate">竣工时间</td>
                ...
                <ItemTemplate>
                    <tr bgcolor="#DEE5FA">
                        ...
                        <td align="center" class="txlrow"><%#Eval("HpType")%></td>
