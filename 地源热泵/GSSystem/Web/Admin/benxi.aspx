<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="benxi.aspx.cs" Inherits="GSSystem.Web.Admin.benxi" %>
...
<body bgcolor="#DEE5FA">
    <form id="form1" runat="server">
        <div>
            <div><img src="left.files/benxi.jpg" width ="100%" height ="146px"/></div>
            <asp:Repeater ID="Repeater1" runat="server">
                ...
                <FooterTemplate>
                 ...
                 <ItemTemplate>
                    <tr bgcolor="#DEE5FA" style="display:<%#Eval("ProAdd").ToString()!="本溪"?"none":""%>">
