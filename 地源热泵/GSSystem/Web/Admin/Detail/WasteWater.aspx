<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WasteWater.aspx.cs" Inherits="GSSystem.Web.Admin.Detail.WasteWater" %>
...
<body style="background: Azure">
    <form id="form1" runat="server">
        <div><img src="../left.files/wsyrb.jpg" width ="100%" style="height: 146px"/>
            ...
            <ItemTemplate>
                <table cellspacing="0" cellpadding="0" width="100%" border="1" align="center" class="datalist">
                    ...
                    <tr>
                        ...
                        <td height="20" width="25%" style="text-align: center"><%#Eval("id")%></td>
                       <td height="20" style="text-align: left" class="style2" >
                            <asp:Label Text="项目名称" runat="server" ></asp:Label></td>
                        <td height="20" width="25%" style="text-align: center"><%#Eval("ProName")%></td>
                        </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2" >
                    ...
                    <tr>
                        <td height="20" style="text-align: left" class="style2" >
                            <asp:Label Text="污水泵数量" runat="server" ></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("SPNum")%></td>
                        <td height="20" style="text-align: left" class="style2" >
                            <asp:Label Text="污水泵扬程" runat="server" ></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("SPHead")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2" >
                            <asp:Label Text="污水泵流量" runat="server" ></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("SPFlow")%></td>
                        <td height="20" style="text-align: left" class="style2" >
                            <asp:Label Text="污水泵功率" runat="server" ></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("SPPower")%></td>
                         </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2" >
                    ...
                    <tr class="altrow">
                        ...
                        <td height="20"  style="text-align: center"><%#Eval("HEHEArea")%></td>
                        <td height="20" style="text-align: left" class="style2" >
                            <asp:Label Text="污水进水温度" runat="server" ></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("SInTemp")%></td>
                         </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2" >
                            <asp:Label Text="污水出水温度" runat="server" ></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("SOutTemp")%></td>
                        <td height="20" style="text-align: left" class="style2" >
                            <asp:Label Text="污水流量" runat="server" ></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("SFlow")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2" >
                        ...
                        <td height="20"  style="text-align: center"><%#Eval("CPETMode")%></td>
                         </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2" >
