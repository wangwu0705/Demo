<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoilSource.aspx.cs" Inherits="GSSystem.Web.Admin.Detail.SoilSource" %>
...
<body style="background: Azure">
    <form id="form1" runat="server">
        <div>
            <img src="../left.files/tryrb.jpg" width="100%" style="height: 146px" />
        ...
        <asp:DataList ID="DataList1" runat="server" CellPadding="4" ForeColor="#333333"
            ...
            <ItemTemplate>
                <table cellspacing="0" cellpadding="0" width="100%" border="1" align="center" class="datalist">
                     <tr>
                        <th>属性</th>
                        <th>信息</th>
                        <th>属性</th>
                    ...
                    <tr class="altrow">
                        ...
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="施工单位" runat="server" Width="150px"></asp:Label></td>
                    ...
                    <tr>
                        ...
                        <td height="20" style="text-align: center"><%#Eval("FinTime","{0:d}")%></td>

                        <td height="20" style="text-align: left" class="style2" width="*">
                    ...
                    <tr class="altrow">
                        ...
                        <td height="20" style="text-align: center"><%#Eval("HpType")%></td>
                        <td height="20" style="text-align: left" class="style2">
                    ...
                    <tr>
                        ...
                        <td height="20" style="text-align: center"><%#Eval("UseFormat")%></td>
                    ...
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="打孔数目" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("PHoleNum")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="孔深" runat="server"></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("HoleDepth")%></td>
                    </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="孔间距" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("HoleDistance")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="地下换热器材质" runat="server"></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("UHEMaterial")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="地下换热器管径" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("UHEDiameter")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="供热时间" runat="server"></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("HeatTime")%></td>
                    </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="制冷时间" runat="server"></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("CoolTime")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="埋管形式" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("BPFormat")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="地下换热器U型" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("UHEUType")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="地下换热器串并联" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("UHESparallel")%></td>
                    </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="地下换热器总管长" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("UHETotalLen")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="水处理仪型号" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("WTIModel")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="定压膨胀罐型号" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("CPETModel")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="定压膨胀罐数量" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("CPETNum")%></td>
                    </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="补水箱大小" runat="server"></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("FWTSize")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="补水泵数量" runat="server"></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("WSPNum")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="补水泵功率" runat="server"></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("WSPPower")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="水泵是否变频" runat="server"></asp:Label></td>
                        <td height="20"  style="text-align: center"><%#Eval("PVFreque")%></td>
                    ...
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2" width="*">
                            <asp:Label Text="热源端循环泵扬程" runat="server" Width="150px"></asp:Label></td>
                    ...
                    <tr class="altrow">
                        ...
                        <td height="20" style="text-align: center"><%#Eval("ProTel")%></td>
                    </tr>
                </table>
            </ItemTemplate>
        </asp:DataList>
