<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurfaceWater.aspx.cs" Inherits="GSSystem.Web.Admin.Detail.SurfaceWater" %>
...
<body style="background: Azure">
    <form id="form1" runat="server">
        <div><img src="../left.files/dbsyrb.jpg" width ="100%" style="height: 146px"/>
        ...
        <asp:DataList ID="DataList1" runat="server" CellPadding="4" ForeColor="#333333"
            ...
            <ItemTemplate>
                <table cellspacing="0" cellpadding="0" width="100%" border="1" align="center" class="datalist">
                    ...
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="详细地址" runat="server" Width="150px"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("DetailAdd")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="项目类型" runat="server" Width="150px"></asp:Label></td>
                    ...
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="水源取水泵数量" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("WPNum")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="水源取水泵扬程" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("WPHead")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="水源取水泵流量" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("WPFlow")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="水源取水泵功率" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("WPPower")%></td>
                    </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="换热器类型" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("HEType")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="换热器数量" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("HENum")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="换热器换热面积" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("HEHeatArea")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="地表水进水温度" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("SWITemp")%></td>
                    </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="地表水出水温度" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("SWOTemp")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="地表水流量" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("SWFlow")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="除砂器数量" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("DNum")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="除砂器型号" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("DType")%></td>
                    </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="软化水箱大小" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("SWTSize")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="软水装置型号" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("SWTType")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="补水泵数量" runat="server"></asp:Label></td>
                        <td height="20" width="20%" style="text-align: center"><%#Eval("WSPNum")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="补水泵功率" runat="server" Width="150px"></asp:Label></td>
                        <td height="20" width="20%" style="text-align: center"><%#Eval("WSPPower")%></td>
                    </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="水泵是否变频" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("PVFrequ")%></td>
                    ...
                    <tr class="altrow">
                        ...
                        <td height="20" width="10%" style="text-align: center"><%#Eval("WUEWSTemp")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="冬用户端回水温度" runat="server"></asp:Label></td>
                        <td height="20" width="10%" style="text-align: center"><%#Eval("WUEBWTemp")%></td>
                    </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                    ...
                    <tr class="altrow">
                        ...
                        <td height="20" width="10%" style="text-align: center"><%#Eval("SHSSBackWTemp")%></td>
                        </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="夏热源侧循环水量" runat="server"></asp:Label></td>
                        <td height="20" width="10%" style="text-align: center"><%#Eval("SHSSCWater")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="夏用户端供水温度" runat="server"></asp:Label></td>
                        <td height="20" width="10%" style="text-align: center"><%#Eval("SUEWSTemp")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="夏用户端回水温度" runat="server"></asp:Label></td>
                        <td height="20" width="10%" style="text-align: center"><%#Eval("SUEBWTemp")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="夏用户端循环水量" runat="server"></asp:Label></td>
                        <td height="20" width="10%" style="text-align: center"><%#Eval("SUECircul")%></td>
                        </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="夏房间温度范围" runat="server"></asp:Label></td>
                        <td height="20" width="10%" style="text-align: center"><%#Eval("SRTempRange")%></td>
                        <td height="20" style="text-align: left" class="style2">
