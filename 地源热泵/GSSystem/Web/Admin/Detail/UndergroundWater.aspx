<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UndergroundWater.aspx.cs" Inherits="GSSystem.Web.Admin.Detail.UndergroundWater" %>
...
<body style="background: Azure">
    <form id="form1" runat="server">
        <div><img src="../left.files/dxsyrb.jpg" width ="100%" style="height: 146px"/>
        ...
        <asp:DataList ID="DataList1" runat="server" CellPadding="4" ForeColor="#333333"
            ...
            <ItemTemplate>
                <table cellspacing="0" cellpadding="0" width="100%" border="1" align="center" class="datalist">
                    ...
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="水源类型" runat="server" Width="150px"></asp:Label></td>
                    ...
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="打井数目" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("WellNum")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="提水井数量" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("WEWNum")%></td>
                    </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="回灌井数量" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("RWNum")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="井深" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("WellDepth")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="单井提水量" runat="server"></asp:Label></td>
                        <td height="20" width="20%" style="text-align: center"><%#Eval("SWWExtract")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="供热时间" runat="server"></asp:Label></td>
                        <td height="20" width="20%" style="text-align: center"><%#Eval("HeatTime")%></td>
                    </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                        ...
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="取水管径" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("WPDiameter")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="取水管材" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("WPipe")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="回水管径" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("BWPDiameter")%></td>
                    </tr>
                    <tr>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="回水管材" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("BWPipe")%></td>
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="除砂器型号" runat="server"></asp:Label></td>
                        <td height="20" style="text-align: center"><%#Eval("DModel")%></td>
                    </tr>
                    <tr class="altrow">
                        <td height="25" style="text-align: left" class="style2">
                            <asp:Label Text="水处理仪型号" runat="server"></asp:Label></td>
                        <td height="25" style="text-align: center"><%#Eval("WTIModel")%></td>
                        <td height="25" style="text-align: left" class="style2">
                            <asp:Label Text="定压膨胀罐型号" runat="server"></asp:Label></td>
                        <td height="25" style="text-align: center"><%#Eval("CPETModel")%></td>
                    </tr>
                    <tr>
                        <td height="25" style="text-align: left" class="style2">
                    ...
                    <tr class="altrow">
                        <td height="20" style="text-align: left" class="style2">
                            <asp:Label Text="机组造价" runat="server" Width="150px"></asp:Label></td>
