<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dandong.aspx.cs" Inherits="GSSystem.Web.Admin.dandong" %>
...
<body bgcolor="#DEE5FA">
    <form id="form1" runat="server">
        <div>
            <div><img src="left.files/dandong.jpg" width ="100%" height ="146px"/></div>
            <asp:Repeater ID="Repeater1" runat="server">
               ...
               <ItemTemplate>
                    <tr bgcolor="#DEE5FA" style="display:<%#Eval("ProAdd").ToString()!="丹东"?"none":""%>">
