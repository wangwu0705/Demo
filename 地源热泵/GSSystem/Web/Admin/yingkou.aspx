<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yingkou.aspx.cs" Inherits="GSSystem.Web.Admin.yingkou" %>
...
<body bgcolor="#DEE5FA">
    <form id="form1" runat="server">
        <div>
            <div><img src="left.files/yingkou.jpg" width ="100%" height ="146px"/></div>
            <asp:Repeater ID="Repeater1" runat="server">
                ...
                <FooterTemplate>
                 ...
                 <ItemTemplate>
                    <tr bgcolor="#DEE5FA" style="display:<%#Eval("ProAdd").ToString()!="营口"?"none":""%>">
