...
namespace GSSystem.Web.UndergroundWater
{
	...
	private void ShowInfo(int id)
	{
		...
		this.txtWellNum.Text=model.WellNum;
		this.txtWEWNum.Text=model.WEWNum;
		this.txtRWNum.Text=model.RWNum;
		this.txtWellDepth.Text=model.WellDepth;
		this.txtSWWExtract.Text=model.SWWExtract;
		this.txtHeatTime.Text=model.HeatTime;
		this.txtCoolTime.Text=model.CoolTime;
		this.txtWPDiameter.Text=model.WPDiameter;
		this.txtWPipe.Text=model.WPipe;
		this.txtBWPDiameter.Text=model.BWPDiameter;
		this.txtBWPipe.Text=model.BWPipe;
		this.txtDModel.Text=model.DModel;
