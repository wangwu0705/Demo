<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectCostEdit.aspx.cs" Inherits="GSSystem.Web.InputDate.ProjectCostEdit" %>
...
<body bgcolor="#DEE5FA">
    <form id="form1" runat="server">
        ...
        <div><img src="../Admin/left.files/xmhzxxxg.gif"  width ="100%" style="height: 30px"/></div>
        <table border="1" width="100%">
            ...
            <tr>
               ...
               <td class="style2">系统总造价：</td>
                <td>
                    <input type="text" name="ProTotalCost" value="<%=BiModel.ProTotalCost%>"/></td>
            </tr>
            <tr>
                <td class="style2">机组造价：</td>
                <td>
                    <input type="text" name="UnitCost" value="<%=BiModel.UnitCost%>"/></td>
          
                <td class="style2">系统造价：</td>
                <td>
                    <input type="text" name="SystemCost" value="<%=BiModel.SystemCost%>"/></td>
            </tr>
            <tr>
                <td class="style2">项目联系电话：</td>
                <td>
                    <input type="text" name="ProTel" value="<%=BiModel.ProTel%>"/></td>                       
            </tr>
            <tr>
