<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeaWater.aspx.cs" Inherits="GSSystem.Web.InputDate.SeaWater1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <img src="../Admin/left.files/hsyxxlb.gif" width="100%" style="height: 30px; margin-bottom: 0px;" />
            </div>
        <div>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <HeaderTemplate>
                    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bordercolor="#799AE1" class="tableBorder">
                        <tbody>
                            <tr>
                                <th align="center" colspan="16" style="height: 23px; border: 1px solid #0058a3;background-color: #4bacff;color: #FFFFFF;font-weight: bold;">海水源热泵信息列表</th>
                            </tr>
                            ...
                            <tr align="center" bgcolor="#799AE1">
                                ...
                                <td width="15%" align="center" class="txlHeaderBackgroundAlternate">海水井数量</td>
                ...
                <ItemTemplate>
                    <tr bgcolor="#DEE5FA">
                        ...
                        <td align="center" ><%#Eval("Dowtherm")%></td>
                         <td align="center" ><%#Eval("SWWellNum")%></td>
                        <td align="center" ><%#Eval("PVariableFre")%></td>
                        <td align="center" >
                            <a style="cursor:pointer" href='SeaWaterEdit.aspx?id=<%#Eval("id") %>'>修改</a>
