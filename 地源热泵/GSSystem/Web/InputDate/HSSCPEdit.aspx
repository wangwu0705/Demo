<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSSCPEdit.aspx.cs" Inherits="GSSystem.Web.InputDate.HSSCPEdit" %>
...
<body bgcolor="#DEE5FA">
    <form id="form1" runat="server">
        ...
        <div><img src="../Admin/left.files/rydc.gif"  width ="100%" style="height: 30px"/></div>
        <table border="1">
             <tr>
                <td class="auto-style4">编号：</td>
                 <td>
                 <%=BiModel.id%>
                 <input type="hidden" name="id" value="<%=BiModel.id%>"/></td>
           
                <td class="auto-style5">项目名称：</td>
                <td>
                    <input type="text" name="ProName" value="<%=BiModel.ProName%>"/></td>
            </tr>
            <tr>
                <td class="auto-style4">水源类型</td>
                <td>
                    <input type="text" name="WType" value="<%=BiModel.WType%>"/></td>
          
                <td class="auto-style5">热源端循环泵数量：</td>
                <td>
                    <input type="text" name="HSSCPNum" value="<%=BiModel.HSSCPNum%>"/></td>
            </tr>
            <tr>
                <td class="auto-style4">热源端循环泵功率：</td>
                <td>
                    <input type="text" name="HSSCPPower" value="<%=BiModel.HSSCPPower%>"/></td>
          
                <td class="auto-style5">热源端循环泵扬程：</td>
                <td>
                    <input type="text" name="HSSCPHead" value="<%=BiModel.HSSCPHead%>"/></td>
            </tr>
            <tr>
                <td class="auto-style4">热源端循环泵流量：</td>
                <td>
                    <input type="text" name="HSSCPFlow" value="<%=BiModel.HSSCPFlow%>"/></td>                       
            </tr>
            <tr>
